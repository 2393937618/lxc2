...
public class RecyclerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private DataBean getChildDataBean(DataBean bean){
        ...
        child.setPlace_id(bean.getPlace_id());
        child.setChildLeftTxt(bean.getChildLeftTxt());
        child.setChildRightTxt(bean.getChildRightTxt());
        child.setComment_num(bean.getComment_num());
        child.setContent_text(bean.getContent_text());
        child.setCreate_time(bean.getCreate_time());
        child.setLike_num(bean.getLike_num());
        child.setPlace_name(bean.getPlace_name());
        child.setCircle_type(bean.getCircle_type());
        return child;
    }
